...
├── dekatrian_date_conversion             # The main python package for the project
...
e.g: `cat dekatrian_date_conversion/VERSION` will get the project version without harming
